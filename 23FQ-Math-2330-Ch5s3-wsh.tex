...
\renewcommand{\mySubTitle}{Section 5.3: Double Integrals in Polar Coordinates} %\\
...
\item Evaluate \(\iint_R x^2+y^2+1 \ dA\) where \(R\) is the disk bounded by \(x^2+y^2=4\).

\vfill

\item Evaluate \(\iint_R (x^2+y^2)^2\ dA\) where \(R\) is the ``bow tie'' region shaded below,\\
...
%%\begin{framed}
%
%\df{\textcolor{sblack}{Key Concept:}}
%
...
%\begin{multicols}{2}
%
%\df{\textcolor{sblack}{Center of Mass of a Lamina:}}
%
%
%\includegraphics[height=2in]{Ch12s4-Lamina}
%
